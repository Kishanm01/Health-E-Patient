			...
			>
				<Box
					...
					sx={{
						...
						gridTemplateRows: "30px 10px 50px 50px 50px 50px 50px 10px",
						gridTemplateAreas:
							'"header header" "Switch Switch" "First Last" "Email Email" "Password Password" "Confrim Confrim" "Submit Submit" "Terms Terms"',
						columnGap: "10px",
						rowGap: "20px",
						alignContent: "center",
					}}
